...
export function buildLayeredPrompt(
  ...
  const instructionBlock = [
    ...
    "Structure your response as follows: 1) Concise summary (2-4 sentences) that directly answers the user's query; 2) Detailed explanation with reasoning and evidence from layers; 3) Concrete recommendations or next steps; 4) Short list of layer files used as sources.",
