...
export function buildLayeredPrompt(
  ...
  const instructionBlock = [
    ...
    "Use Markdown for readability (headings, lists, and fenced code blocks where helpful), but do not use Markdown tables or any pipe-based formatting. Avoid math notation with dollar signs.",
    "Start with a short concise summary, then provide a detailed explanation with inline citations to layer files when appropriate, followed by concrete recommendations or next steps, and finally a short list of sources.",
    ...
    "When there are trade-offs or multiple options, present a brief pros/cons comparison and a recommended choice with reasoning, using lists instead of tables.",
