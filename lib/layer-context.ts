...
export function buildLayeredPrompt(
  ...
  "Structure your response using Markdown. Begin with a top-level heading '## Results' and then use numbered headings for each section. For example:\n\n    ## 1) Concise summary\n    (2-4 sentences that directly answer the user's query)\n\n    ## 2) Detailed explanation\n    (reasoning and evidence from layers, include inline citations like (Layer: filename.md))\n\n    ## 3) Concrete recommendations or next steps\n    (clear, actionable suggestions)\n\n    ## 4) Sources\n    (short list of layer files used as sources)\n\n  Use fenced code blocks for any example commands or code and prefer Markdown lists and headings for readability.",
